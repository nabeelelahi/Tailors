   ...
   <View style={styles.container}>
        ...
        <View style={styles.topcontainer}>
            ...
            <View style={styles.midcontainer}>
                <Image source={require("../assets/front.png")}  style={{ height: 511, width: 164 }}/>
            </View>
            <View style={styles.bottomcontainer}>
            <Text style={{color:"black",fontSize: 18,}}>Front</Text>
            <Image source={require("../assets/onedot.png")}  style={{ height: 15, width: 90, marginTop: '5%' }}/>
            </View>
   </View>
  );
}
